...
define("user/verifyImg", function(require) {
    ...
    return function(option) {
        ...
        var result = new BaseLayer({
            html: "<p>" + '<span class="hintTitle">请先输入以下图形验证码</span><input type="text" validate="notNull,length" validatedata="length=5" validatename="验证码"><img src="' + opt.url + '">' + "</p>" + '<button class="actValidate">确定</button>' + '<a href="#" class="actClose">×</a>',
            style: {
                position: "fixed",
                background:"#fff",
